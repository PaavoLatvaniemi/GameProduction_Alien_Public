...
public class SearchRandomRoomState : BaseState
{
    Alien alien;
    NavMeshAgent nav;
    ...
    public SearchRandomRoomState(Alien _alien) : base(_alien.gameObject)
    {
        alien = _alien;
    ...
    {
        room = SearchableRooms.GetAvailableRoom();
        if(room != null)
        {
    ...
    {
        if (room == null) return typeof(IdleState);
